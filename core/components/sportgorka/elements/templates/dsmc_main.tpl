        ...
        <div class="page_slider_mark2">
            <ul>
                ...
                {foreach $rows as $row}
                    <li>
                        <a href="{$row.link}">
                            <img style="margin: 0 auto;display: block;" src="userimg/{$row.image}" alt="Баннеры слайдера" />
                        </a>
                    </li>
                {/foreach}
...
<div class="container" itemprop="mainContentOfPage">
    <div class="title_centered">
        ...
        <span style="display:none;" class="title_centered_icons"><i class="fa fa-times" aria-hidden="true"></i> <i class="fa fa-times" aria-hidden="true"></i> <i class="fa fa-times" aria-hidden="true"></i></span>
    </div>
    <div class="text_centered" style="font-size: 16px;line-height: 1.8em;margin-bottom:30px;margin-top:0;">«СпортГорка» - <strong>производитель недорогих детских площадок</strong> для дачи, детсадов, городских территорий с опытом более 10 лет. Мы готовы предложить большой выбор спортивно-игровых комплексов. У нас есть предприятие полного цикла и офис недалеко от центра Санкт-Петербурга, где представлены готовые примеры продукции и проекты уличных пространств.</div>
    <div class="text_centered" style="font-size: 16px;line-height: 1.8em;margin-bottom:30px;margin-top:0;"><strong>Материалы</strong>, которые мы используем при производстве, <strong>сертифицированы, имеют гарантию</strong> от производителя. Это обеспечивает надежность и качество деревянных домиков, пластиковых горок, песочниц, веревочных лестниц, резиновых покрытий.</div>
</div>
...
<div class="container">
    ...
    <div class="text_centered">Мы создаем проекты для детей разного возраста и физических возможностей. Они помогают им правильно, быстро развиваться. <strong>На наших площадках безопасно играть</strong> круглый год! Детальное изучение и проработка каждого заказа позволяет обустроить увлекательную игровую зону прямо на загородном участке.</div>
...
<div class="index_preim_belt">
    <div class="index_preim_belt_bg">
        <div class="index_preim_belt_title"><div>Плюсы</div><span>СпортГорки</span></div>
        ...
        <div class="index_preim_belt_note">
            Качество используемых материалов, собственные чертежи дают большую гарантию в 18 месяцев на деревянные, металлические, пластиковые части комплексов.</div>
    </div>
</div>
<div class="container">
    <div class="title_centered">
    ...
    <div class="text_centered" style="font-size:16px;line-height:1.7em;margin-left:100px;margin-right:100px">Производимые горки полностью безопасны, имеют прочные бортики. Мы устанавливаем пластиковые горки, либо производим их из полированной нержавеющей стали, ламинированной фанеры или дибонда. Дибонд – это композитный износостойкий материал. Он устойчив к морозам, осадкам, перепадам температур, что очень важно для продукции, эксплуатируемой в Санкт-Петербурге.</div>
...
<div class="container">
    ...
    <div class="text_centered" style="font-size:16px;line-height:1.7em;margin-left:100px;margin-right:100px">Мы создадим многофункциональную интересную конструкцию из игровых компонентов, спортивных снарядов, которая станет уголком развлечений для малышей и подростков. При необходимости мы дополним готовые проект набором нужных составляющих и комплектующих. <strong>Цены на детские площадки</strong> для дачи и города начинаются <strong>от 30 000 рублей</strong>. Это на целых 40% меньше, чем у других компаний. При этом качество материалов на порядок выше, ведь <strong>мы НЕ покупаем</strong> оборудование, детали, <strong>материалы в Китае!</strong>
    </div>
...
<div class="how_we_work_index" style="padding-bottom: 10px;">
    <div class="container">
        <div class="title_centered">
            ...
            <span style="display: none;" class="title_centered_icons"><i class="fa fa-times" aria-hidden="true"></i> <i class="fa fa-times" aria-hidden="true"></i> <i class="fa fa-times" aria-hidden="true"></i></span>
            <div class="text_centered" style="margin-left:0;margin-right:0;">Деревянные формы прочные и абсолютно безопасные. На производстве каждая деталь проходит тщательную шлифовку, чтобы защитить детей от заноз, а углы деревянных деталей фрезеруются.
            </div>
        </div>
        ...
        <div class="steps_text_mobile_wrap">
            <!--noindex--><div class="steps_text_mobile owl-carousel owl-theme">

                <div class="item"><div>Консультация и прием заявки</div></div>
                <div class="item"><div>Согласование проекта</div></div>
                <div class="item"><div>Производство</div></div>
                <div class="item"><div>Предварительная сборка</div></div>
                <div class="item"><div>Контроль качества</div></div>
                <div class="item"><div>Отправка</div></div>
                <div class="item"><div>Монтаж</div></div>
                <div class="item"><div>18 месяцев гарантии</div></div>

            </div><!--/noindex-->
        </div>
        <div class="hr"></div>
        <div class="text_centered" style="margin-left:0;margin-right:0;">Производство находится в поселке Бугры на севере города. В него входит столярный, сварочный и сборочный цеха. Мы сами производим и окрашиваем металлические, деревянные компоненты. Это позволяет компании «СпортГорка» предлагать <strong>стабильно низкие цены с 2013 г</strong>. Мы системно подходим к выпуску каждой детали конструкции с момента ее проектирования до монтажа прямо на участке.</div>
...
<div class="latest_work">
    <div class="container">
        ...
        <div class="text_centered" style="font-size:16px;line-height:1.7em;margin-left:100px;margin-right:100px">При <strong>изготовлении деревянных комплексов</strong> мы используем клееный брус, массив сосны мебельной влажности. Древесина имеет антисептическое покрытие, что защищает ее от гниения и насекомых. Это позволяет не окрашивать деревянные элементы, оставляя их натуральный цвет. <strong>Пластик мы покупаем в Европе, а дерево – в Карелии!</strong> Каждый день мы создаем новые площадки и дарим радость детям. Взгляните на наши новые работы:
            ...
            <div class="text_centered" style="font-size:16px;">Мы готовы организовать доставку, а также монтаж в любом населенном пункте Ленинградской области. Мы можем доставить их по России, СНГ.</div>
            <div class="text_centered" style="font-size:16px;">При самостоятельном монтировании мы обеспечим для вас предварительную сборку, предоставим ясные инструкции по окончательной сборке. Вам останется только собрать воедино крупные модули и предоставить остальное вашим детям!
            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="text_centered" style="font-size:16px;">
                        Предприятие полного цикла находится в поселке Бугры. На нем было создано более 3000 проектов для частных клиентов, государственных учреждений и юридических лиц. Мы работаем только с экологически чистыми материалами, не закупаем китайские комплектующие! На производстве работают только квалифицированные сотрудники с многолетним опытом. Это позволяет давать нам 18 месяцев гарантию на всю продукцию!
                    </div>
                    <div class="text_centered" style="font-size:16px;">
                        Команда SportGorka  – это сработавшийся за годы коллектив из опытных менеджеров, проектировщиков, сборщиков и работников производственного цеха компании. Отлаженные рабочие процессы и эффективная работы команды – залог скорости поставки, качества комплектующих и долговечности комплексов.
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="slider owl-carousel owl-theme">
                        <div class="item"><img alt="" src="css/images/ic1.png" /><a href="/kompleksi-dlya-dachi.html"><span>Детские площадки</span><br><span>для дачи</span></a></div>
                        <div class="item"><img alt="" src="css/images/ic2.png" /><a href="/kompleksi-dlya-goroda.html"><span>Детские площадки</span><br><span>для города</span></a></div>
                        <div class="item"><img alt="" src="css/images/ic5.png" /><a href="/tenevie-navesi.html"><span>Теневые</span><br><span>навесы</span></a></div>
                        <div class="item"><img alt="" src="css/images/ic3.png" /><a href="/zimnie-gorki.html"><span>Зимние</span><br><span>горки</span></a></div>
                        <div class="item"><img alt="" src="css/images/ic4.png" /><a href="/oborudovanie-dlya-gorodskih-plochadok.html"><span>Оборудование</span><br><span>и элементы</span></a></div>

                        <div class="item"><img alt="" src="css/images/ic6.png" /><a href="/rezinovie-pokritiya.html"><span>Резиновые</span><br><span>покрытия</span></a></div>
                    </div>
                </div>
            </div>
        </div>
