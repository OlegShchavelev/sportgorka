            ...
            <div class="product_page row">
                <div class="col-xs-9 product_image">
                    <div class="items-images-tovaras">
                        ...
                        {'popular' | resource == 1 ? '<a href="' ~ ('459' | url) ~ '"><span class="def"><img src="css/images/def.png" alt="Антивандальная конструкция" title="Антивандальная конструкция" width="50" height="50"><span class="text">Антивандальная конструкция</span></span>' : ''}
